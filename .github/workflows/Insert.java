...
public class Insert extends JFrame {
	...
	public Insert() {
		try {
	     ...
	     PreparedStatement p1 =con.prepareStatement("insert into user_1(user_name, pass, designation, first_name, last_name,contact_no, address, email_id, user_aadhar) values(?,?,?,?,?,?,?,?,?)");
	     ...
	     PreparedStatement p6 = con.prepareStatement("call daywise_seat_availability(?, ?, ?,?)");
	     
	     PreparedStatement p7 = con.prepareStatement("select vehicle_id, vehicle_seats from vehicle where vehicle_status ='active'");

	     PreparedStatement p8 = con.prepareStatement("select travel_date from vehicle_avail group by travel_date having travel_date > curdate()");
	     
	     
	     //setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 1120, 636);
		...
		tf_10.setBounds(234, 412, 210, 38);
		//contentPane.add(tf_10);
		tf_10.setColumns(10);
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					if(x=="Users") {
						...
						p1.setString(5, tf6.getText());
						p1.setLong(6, Integer.parseInt(tf5.getText()));
						p1.setString(7, tf7.getText());
						p1.setString(8, tf8.getText());
						p1.setLong(9,Long.parseLong(tf_10.getText()));
						p1.executeUpdate();
					...
					if(x=="Routes") {
						...
						for(i=0;i<=count;i++) {
							rs4 = p7.executeQuery();
							while(rs4.next()) {
								 p6.setString(1, rs4.getString("vehicle_id"));
					    		 p6.setInt(2, rs4.getInt("vehicle_seats"));
					    		 p6.setInt(3, i);
					    		 p6.setString(4, tf1.getText());
					    		 p6.executeQuery();
							}
						}
		...
		lblNewLabel.setBounds(0, 0, 1116, 75);
		contentPane.add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("New label");
		lblNewLabel_1.setBounds(0, 0, 1116, 598);
		ImageIcon imgIcon = new ImageIcon("C:\\Users\\mahes\\Downloads\\1510516.jpg");
